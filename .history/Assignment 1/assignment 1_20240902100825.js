  ...
  for (const restaurant of restaurants) {
    if (restaurant) {
          ...
          row.addEventListener('click', async function () {
            // fetch menu data
            try {
              const menu = await fetchData(apiURL + '/api/v1/restaurants/daily/:id/:lang');
            ...
            info.innerHTML = '<p>Failed to load menu. Please try again later.</p>';
          }
